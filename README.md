...
A module for [bitcore](https://github.com/bitchk-wallet/bitcore) that implements [Payment Protocol](https://github.com/bitcoin/bips/blob/master/bip-0070.mediawiki) and other related BIPs.
